...
(() => {
  ...
  const grades={
    '沖野 凌我':'4','小野寺 颯太':'4','庄司 瑞輝':'4','早乙女 良真':'4','高草木 架月':'4','西村 悠誠':'4','藤原 幹大':'4','宮倉 騎士':'4','棟方 一楽':'4','和田 麻里':'4',
  ...
  Object.keys(pb).forEach(name=>{ if(!rosterNames.has(norm(name))) current.push([name,grades[name]||'']); });
  roster[team]=current;
