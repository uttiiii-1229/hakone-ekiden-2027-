...
(() => {
  ...
  const meetCatalog=[
    ...
    {id:'kanto-ic-2026',year:2026,name:'関東学生陸上競技対校選手権大会（関東インカレ）',type:'インカレ',period:'2026年5月',venue:'関東',status:'結果収録準備中'},
  ...
  const meetResults={
    'student-individual-2026':{
      ...
      events:{
        '男子1500m':[
          [1,'森玉 鳳雅','関西大学','4','3:44.85',''],
          [2,'藤井 奏汰','広島経済大学','4','3:46.16',''],
          [3,'渡邉 優典','東北大学','4','3:46.32',''],
          [4,'川口 峻太朗','順天堂大学','2','3:46.43',''],
          [5,'馬場 アンジェロ光','東洋大学','3','3:48.00',''],
          [6,'田村 幸太','創価大学','1','3:49.60',''],
          [7,'野川 元希','明治大学','3','3:50.02',''],
          [8,'高坂 光希','札幌学院大学','4','3:51.18','']
        ],
        '男子5000m':[
          ['—','佐々木 大輝','青山学院大学','3','—','DNS'],
          ['—','神邑 亮佑','青山学院大学','2','—','DNS']
        ...
        '男子3000mSC':[
          [1,'キプゲノ ケネス','札幌学院大学','2','8:50.63',''],
          [2,'古賀 想太','筑波大学','1','8:51.40',''],
          [3,'前田 結人','順天堂大学','1','8:54.48',''],
          [4,'辻 昂介','順天堂大学','3','9:01.88',''],
          ['—','小林 周太郎','明治大学','4','—','DNS'],
          ['—','加藤 結羽','神奈川大学','1','—','DNS']
        ],
        '男子10000mW':[
          [1,'吉迫 大成','東京学芸大学','4','38:07.06','NGR'],
          [2,'中島 佑之','山梨学院大学','4','38:28.07','NGR'],
          [3,'逢坂 草太朗','東洋大学','3','39:18.36',''],
          [4,'金子 陸','国士舘大学','4','40:07.16',''],
          [5,'長田 隼人','明治大学','4','40:09.82',''],
          [6,'玉春 汰造','新潟食料農業大学','2','40:15.97',''],
          [7,'原 勇輔','山梨学院大学','3','40:23.92',''],
          [8,'中台 琥珀','順天堂大学','3','40:24.00','']
        ]
      }
    }
  };
