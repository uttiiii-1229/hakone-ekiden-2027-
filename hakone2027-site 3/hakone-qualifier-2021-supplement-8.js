...
(() => {
  ...
  // Continue loading official DNF/DQ records without requiring an index.html edit.
  if (!document.querySelector('script[data-hakone-q-2021-s9]')) {
    const s = document.createElement('script');
    s.src = 'hakone-qualifier-2021-supplement-9.js';
    s.dataset.hakoneQ2021S9 = '1';
