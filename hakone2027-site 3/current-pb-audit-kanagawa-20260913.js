...
(() => {
  ...
  const audits={
    // 4th year
    '大岩 蓮':['14:11.33','29:18.00','1:03:44'],
    '滝本 朗史':['13:56.56','28:49.40','1:03:34'],
    '新妻 玲旺':['13:58.80','28:51.98','1:02:16'],
    '花井 創':['14:21.05','28:51.22','1:01:41'],
    '平川 瑠星':['14:08.27','28:46.61','1:05:16'],
    '三原 涼雅':['14:23.27','28:53.12','1:02:40'],
    '森 稜真':['14:24.85','30:00.44','1:03:30'],
    '山本 琉楓':['14:08.43','29:29.80','1:04:09'],
    // 3rd year
    '淺田 龍':['14:35.12','31:33.19','—'],
    '安部 爽仁朗':['14:36.43','30:57.19','1:05:49'],
    '上田 航大':['14:18.90','28:43.93','1:03:11'],
    '遠藤 優裕':['14:20.93','29:38.20','1:04:18'],
    '太田 宗一郎':['14:25.89','31:57.09','1:04:54'],
    '小林 亮太':['14:12.45','—','—'],
    '近藤 大智':['14:11.67','29:24.73','1:02:50'],
    '野間 黎矢':['14:17.62','29:42.55','1:05:55'],
    '柳生 琥珀':['14:52.17','32:19.22','1:04:14'],
    // 2nd year
    '牛嶋 勇斗':['14:18.91','29:34.91','1:13:06'],
    '金山 隆斗':['14:20.11','29:51.06','1:04:30'],
    '木村 駿太':['14:35.62','—','1:04:00'],
    '佐伯 遥大':['14:30.78','30:24.15','—'],
    '佐藤 輝':['14:23.17','—','1:08:49'],
    '清水 陽永':['14:40.89','—','1:06:33'],
    // 1st year
    '梅木 新太':['14:24.02','—','—'],
    '小田垣 茉周':['14:18.10','—','—'],
    '北村 海智':['14:06.56','—','—'],
  ...
  const grades={
    '大岩 蓮':'4','滝本 朗史':'4','新妻 玲旺':'4','花井 創':'4','平川 瑠星':'4','三原 涼雅':'4','森 稜真':'4','山本 琉楓':'4',
    '淺田 龍':'3','安部 爽仁朗':'3','上田 航大':'3','遠藤 優裕':'3','太田 宗一郎':'3','小林 亮太':'3','近藤 大智':'3','野間 黎矢':'3','柳生 琥珀':'3',
    '牛嶋 勇斗':'2','金山 隆斗':'2','木村 駿太':'2','佐伯 遥大':'2','佐藤 輝':'2','清水 陽永':'2',
    '梅木 新太':'1','小田垣 茉周':'1','北村 海智':'1','小林 歩夢':'1','佐藤 柊斗':'1','鈴木 富大':'1','髙橋 功平':'1','豊川 滉大':'1','新妻 昂己':'1','藤田 慶太':'1','山崎 碧葉':'1','山崎 寿和':'1','由井 蓮':'1'
  };
  ...
  if(!resolver?.currentRows || resolver.__kanagawaOfficialAudit20260913)return;
  ...
  resolver.currentRows=function(currentTeam){
    ...
    Object.entries(audits).forEach(([name,v])=>{
      ...
      if(!row.sources.includes('Kanagawa University official 2026 athlete profile'))row.sources.push('Kanagawa University official 2026 athlete profile');
  ...
  resolver.__kanagawaOfficialAudit20260913=true;
})();
